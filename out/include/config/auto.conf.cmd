...
ifneq "$(KERNELVERSION)" "4.19.272"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "clang version 17.0.6 (https://github.com/llvm/llvm-project 6009708b4367171ccdbf4b5905cb6a803753fe18)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/xm/clgcc/clang17/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/xm/clgcc/arm-gnu-14.2/bin/aarch64-none-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/home/xm/clgcc/arm-gnu-14.2/bin/aarch64-none-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/home/xm/clgcc/arm-gnu-14.2/bin/aarch64-none-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-none-linux-gnu --prefix=/home/xm/clgcc/arm-gnu-14.2/bin/aarch64-none-linux-gnu- --gcc-toolchain=/home/xm/clgcc/arm-gnu-14.2 -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
endif
ifneq "$(CROSS_COMPILE_COMPAT)" "/home/xm/clgcc/arm-gnu-14.2/bin/aarch64-none-linux-gnu-"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "g++"
include/config/auto.conf: FORCE
